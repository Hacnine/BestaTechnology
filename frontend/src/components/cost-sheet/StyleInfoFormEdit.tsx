...
import StyleCustomFields from "./StyleCustomFields";
...
const StyleInfoFormEdit = ({ form }: StyleInfoFormEditProps) => {
  ...
  // Initialize image preview if there's existing image data
  useEffect(() => {
    const existingImage = form.watch("image");
    if (existingImage && typeof existingImage === "string") {
      console.log("Initializing with existing image:", existingImage);
  ...
  const handleImageUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (e) => {
        ...
        console.log("Image preview URL:", result?.substring(0, 50) + "...");
        ...
        <div className="pt-5">
          ...
          <div className="space-y-2">
            ...
            {imagePreview && (
              <div className="mt-2">
                <img
                  src={selectedImage ? imagePreview : `${url.BASE_URL}${encodeURI(imagePreview)}`}
                  alt="Preview"
